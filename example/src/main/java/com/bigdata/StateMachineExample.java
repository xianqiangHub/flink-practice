 ...
 * <p>
 * 状态不仅做简单的累加，此example是状态机，事件不断的走到下一个状态
 * 比如，购物的时候一下单，状态 为待付款-》已付款 待发货 -》已发货 待签收-》已签收
 * 并且处理非法状态并警报，比如已签收之后执行取消订单
 */
